...
namespace s3d
{
	...
	public:
		...
		[[nodiscard]]
		constexpr pointer operator [](size_t y) SIV3D_LIFETIMEBOUND;

		[[nodiscard]]
		constexpr const_pointer operator [](size_t y) const SIV3D_LIFETIMEBOUND;
	...
	# ifdef __cpp_multidimensional_subscript
		...
		[[nodiscard]]
		constexpr reference operator [](size_t x, size_t y)& SIV3D_LIFETIMEBOUND;

		[[nodiscard]]
		constexpr const_reference operator [](size_t x, size_t y) const& SIV3D_LIFETIMEBOUND;
