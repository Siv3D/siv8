...
namespace s3d
{
	namespace Math
	{
		...
		/// @brief 双曲線正接（ハイパボリックタンジェント）を返します。
		...
		/// @brief 値またはベクトルを正規化します。
		/// @remark スカラー値の場合は -1, 0, 1 のいずれかを返します。ベクトルの場合は単位ベクトル化します。
