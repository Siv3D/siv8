...
namespace s3d
{
	namespace Geometry2D
	{
		...
		////[[nodiscard]]
		////bool Intersects(const Bezier2& a, const RoundRect& b) noexcept;

		//[[nodiscard]]
		//bool Intersects(const Bezier2& a, const SuperEllipse& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier2& a, const Polygon& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier2& a, const MultiPolygon& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier2& a, const LineString& b) noexcept;
		...
		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const Rect& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const RectF& b) noexcept;
		...
		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const Triangle& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const Quad& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const RoundRect& b) noexcept;

		//[[nodiscard]]
		//bool Intersects(const Bezier3& a, const SuperEllipse& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const Polygon& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const MultiPolygon& b) noexcept;

		////[[nodiscard]]
		////bool Intersects(const Bezier3& a, const LineString& b) noexcept;
		...
		////[[nodiscard]]
		////bool Intersects(const Rect& a, const Bezier3& b) noexcept;
		...
		//[[nodiscard]]
		//inline bool Intersects(const Rect& a, const LineString& b) noexcept;
		...
		////[[nodiscard]]
		////bool Intersects(const RectF& a, const Bezier3& b) noexcept;
		...
		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Point& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Vec2& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Line& b) noexcept;
		...
		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Rect& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const RectF& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Circle& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Ellipse& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Triangle& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Quad& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const RoundRect& b) noexcept;

		//[[nodiscard]]
		//bool Intersects(const LineString& a, const SuperEllipse& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const Polygon& b) noexcept;

		//[[nodiscard]]
		//inline bool Intersects(const LineString& a, const MultiPolygon& b) noexcept;
