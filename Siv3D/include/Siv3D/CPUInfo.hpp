...
namespace s3d
{
	...
	/// @brief CPU が AVX 命令セットをサポートしているかを返します。
	/// @return CPU が AVX 命令セットをサポートしている場合 true, それ以外の場合は false
	[[nodiscard]]
	...
	/// @brief CPU が AVX2 命令セットをサポートしているかを返します。
	/// @return CPU が AVX2 命令セットをサポートしている場合 true, それ以外の場合は false
	[[nodiscard]]
