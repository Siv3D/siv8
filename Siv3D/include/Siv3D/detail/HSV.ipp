...
namespace s3d
{
	...
	constexpr HSV HSV::hueShifted(const double degrees) const noexcept
	{
		return{ (h + degrees), s, v, a };
	}
	...
	constexpr HSV HSV::complemented() const noexcept
	{
		return hueShifted(180.0);
	}
