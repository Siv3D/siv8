	...
	namespace Math
	{
		namespace detail
		{
			...
			struct Saturate_impl
			{
				...
				/// @param v ベクトル
				/// @return 各成分が0.0以上1.0以下にクランプされたベクトル
				[[nodiscard]]
				constexpr Float2 operator ()(const Float2 v) const noexcept
				{
