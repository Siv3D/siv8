...
namespace s3d
{
	...
	constexpr RoundRect RoundRect::copiedToTop(const double distance) const noexcept
	{
		return{ rect.copiedToTop(distance), r };
	}
	...
	constexpr RoundRect RoundRect::copiedToRight(const double distance) const noexcept
	{
		return{ rect.copiedToRight(distance), r };
	}
	...
	constexpr RoundRect RoundRect::copiedToBottom(const double distance) const noexcept
	{
		return{ rect.copiedToBottom(distance), r };
	}
	...
	constexpr RoundRect RoundRect::copiedToLeft(const double distance) const noexcept
	{
		return{ rect.copiedToLeft(distance), r };
	}
	...
	constexpr RoundRect RoundRect::lerp(const RoundRect& other, const double f) const noexcept
	{
		return{ rect.lerp(other.rect, f), Math::Lerp(r, other.r, f) };
	}
	...
	double RoundRect::distanceTo(const Shape2DType& other) const
	{
