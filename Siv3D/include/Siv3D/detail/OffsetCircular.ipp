...
namespace s3d
{
	...
	template <Concept::FloatingPoint Float, int32 Oclock>
	constexpr OffsetCircularBase<Float, Oclock> OffsetCircularBase<Float, Oclock>::withOffsetR(const value_type _r) const noexcept
	{
		return{ center, (r + _r), theta };
	}
	...
	template <Concept::FloatingPoint Float, int32 Oclock>
	constexpr OffsetCircularBase<Float, Oclock> OffsetCircularBase<Float, Oclock>::withOffsetTheta(const value_type _theta) const noexcept
	{
		return{ center, r, (theta + _theta) };
	}
	...
	{
		return HashFloats(center.x, center.y, r, theta);
	}
