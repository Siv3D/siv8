...
namespace s3d::detail
{
	...
	{
		[[nodiscard]]
		constexpr auto operator ()(Concept::Signed auto x) const noexcept
		{
			return ((x < 0) ? -x : x);
		}
	};
	...
	{
		[[nodiscard]]
		constexpr auto operator ()(Concept::Enum auto x) const noexcept
		{
	...
	struct IsOdd_impl
	{
		...
		[[nodiscard]]
		constexpr bool operator()(const Concept::Integral auto& x) const
		{
			return ((x % 2) != 0);
		}
	};
