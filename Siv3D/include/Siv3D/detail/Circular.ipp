...
namespace s3d
{
	...
	template <Concept::FloatingPoint Float, int32 Oclock>
	constexpr CircularBase<Float, Oclock> CircularBase<Float, Oclock>::withOffsetR(const value_type _r) const noexcept
	{
		return{ (r + _r), theta };
	}
	...
	template <Concept::FloatingPoint Float, int32 Oclock>
	constexpr CircularBase<Float, Oclock> CircularBase<Float, Oclock>::withOffsetTheta(const value_type _theta) const noexcept
	{
		return{ r, (theta + _theta) };
	}
