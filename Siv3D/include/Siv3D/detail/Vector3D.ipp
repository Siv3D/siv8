...
namespace s3d
{
	...
	template <Concept::FloatingPoint Float>
	bool Vector3D<Float>::isFinite() const noexcept
	{
	...
	template <Concept::FloatingPoint Float>
	constexpr void Vector3D<Float>::setZero() noexcept
	{
		x = 0;
		y = 0;
		z = 0;
	...
	template <Concept::FloatingPoint Float>
	constexpr Vector3D<Float> Vector3D<Float>::NaN() noexcept
	{
		constexpr value_type nan = Math::Constants::QNaN_v<value_type>;
		return{ nan, nan, nan };
	}
