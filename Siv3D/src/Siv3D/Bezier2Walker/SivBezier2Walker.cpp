...
namespace s3d
{
	...
	double Bezier2Walker::advanceBy(const double distance, const int32 iterations) noexcept
	{
		double remainderUnused = 0.0;
		return advanceBy(distance, remainderUnused, iterations);
	}

	double Bezier2Walker::advanceBy(const double distance, double& remainder, int32 iterations) noexcept
	{
