...
namespace s3d
{
    namespace
    {
        ...
        static constexpr std::array<TextureFormatData, 15> TextureFormatPropertyTable =
        { {
			{ U"Unknown", DXGI_FORMAT_UNKNOWN, MTLPixelFormat(0), GL_CONSTANTS(0), GL_CONSTANTS(0), GL_CONSTANTS(0), WGPU_CONSTANTS(0), 0, 0, false },
