...
namespace s3d
{
	void Formatter(FormatData& formatData, const SimdFloat4& value)
	{
...
fmt::format_context::iterator fmt::formatter<s3d::SimdFloat4>::format(const s3d::SimdFloat4& value, fmt::format_context& ctx) const
{
...
s3d::ParseContext::iterator fmt::formatter<s3d::SimdFloat4, s3d::char32>::parse(s3d::ParseContext& ctx)
{
	return s3d::FmtHelper::GetFormatTag(tag, ctx);
}

s3d::BufferContext::iterator fmt::formatter<s3d::SimdFloat4, s3d::char32>::format(const s3d::SimdFloat4& value, s3d::BufferContext& ctx) const
{
	const s3d::Float4 xyzw = value.toFloat4();
