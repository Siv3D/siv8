...
namespace s3d
{
	void GradientGlyphRenderer::draw(const TextureRegion& textureRegion, const Vec2& pos, [[maybe_unused]] const int32 index, const double top, const double bottom, const bool isColorGlyph) const
	{
