...
namespace s3d
{
	...
	InputGroup::InputGroup(const Array<Input>& inputs, const Array<InputCombination>& inputCombinations)
		: m_inputs(inputs)
		, m_inputCombinations(inputCombinations)
	{
		m_inputs.sort_and_unique();
		m_inputCombinations.sort_and_unique();
	}
	...
	int32 InputGroup::pressedCount() const
	{
		int32 num = 0;
