...
namespace s3d
{
	...
	public:
		...
		virtual RectF draw(Font::IDType handleID, StringView s, const Array<ResolvedGlyph>& resolvedGlyphs, const Vec2& pos, double fontSize, const TextStyle& textStyle, const ColorF& color, double lineHeightScale, ReadingDirection readingDirection) = 0;

		virtual RectF drawBaseFallback(Font::IDType handleID, const ResolvedGlyph& resolvedGlyph, const Vec2& pos, double fontSize, const TextStyle& textStyle, const ColorF& color, double lineHeightScale, ReadingDirection readingDirection) = 0;
	};
}
