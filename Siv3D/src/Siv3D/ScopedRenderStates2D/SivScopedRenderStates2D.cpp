...
namespace s3d
{
	...
	ScopedRenderStates2D::ScopedRenderStates2D(const SamplerState& samplerState)
		: m_oldSamplerStateInfos{ { ShaderStage::Pixel, 0, Graphics2D::GetPSSamplerState() } }
	{
		Graphics2D::Internal::SetPSSamplerState(0, samplerState);
	}
	...
	ScopedRenderStates2D::~ScopedRenderStates2D()
	{
		if (m_oldBlendState)
		{
			Graphics2D::Internal::SetBlendState(*m_oldBlendState);
		}

		if (m_oldRasterizerState)
		{
			Graphics2D::Internal::SetRasterizerState(*m_oldRasterizerState);
		}
