...
namespace s3d
{
	...
	{
		[[nodiscard]]
		constexpr DWORD MakeCreationDisposition(const OpenMode openMode) noexcept
		{
	...
	{
		LOG_TRACE(fmt::format("BinaryWriter::BinaryWriterDetail::open(\"{0}\", {1})", path, FromEnum(openMode)));
