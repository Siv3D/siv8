...
- [Geometry2D](geometry2d/README.md): boundary queries and continued-ray investigations.
- [JSON](json/README.md): JSON data handling, ownership, representation limits, and validation.
