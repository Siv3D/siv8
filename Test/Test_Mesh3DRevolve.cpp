...
namespace
{
	...
	static_assert(requires
	{
		...
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::initializer_list<Vec2>, uint32)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32, Vec3)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32, Vec3, const Quaternion&)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32, const Mat4x4&)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32, double)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::initializer_list<Vec2>, uint32, double)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32, double, Vec3)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32, double, Vec3, const Quaternion&)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, uint32, double, const Mat4x4&)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::initializer_list<Vec2>, double, double, uint32, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, Vec3, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, Vec3, const Quaternion&, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, const Mat4x4&, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, double, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::initializer_list<Vec2>, double, double, uint32, double, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, double, Vec3, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, double, Vec3, const Quaternion&, CloseEnds)>(&Mesh3DBuilder::addRevolve);
		static_cast<Mesh3DAddResult (Mesh3DBuilder::*)(std::span<const Vec2>, double, double, uint32, double, const Mat4x4&, CloseEnds)>(&Mesh3DBuilder::addRevolve);
	});
