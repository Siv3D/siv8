...
- The final row shows patterned circles. On both backends, the pattern follows
  the full drawing transform: dots rotate and stretch with the geometry. Pattern
  coordinates are independent of the RMS estimate used for tessellation.
