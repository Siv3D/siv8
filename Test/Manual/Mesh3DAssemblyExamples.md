...
This manual regression check exports a complete model as one OBJ and one MTL.
...
For modeling techniques and export conventions, see the [Assembly guide](../../docs/mesh3d/assembly.md).
